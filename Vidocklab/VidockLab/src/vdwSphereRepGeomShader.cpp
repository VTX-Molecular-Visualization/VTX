...
#include "vdwSphereRepGeomShader.hpp"

#include "app.hpp"

namespace vidocklab
{
	VdwSphereRepGeomShader::VdwSphereRepGeomShader(const AMolecule *mol)
		: AMoleculeRep(mol)
	{
		...
		// m_program->attachShader("sphereImpostorGeomTriangle.geom");
	...
	VdwSphereRepGeomShader::~VdwSphereRepGeomShader()
	{
	...
	void VdwSphereRepGeomShader::initBuffers()
	{
