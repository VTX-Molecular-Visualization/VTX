...
namespace VTX::View::UI::Widget::Measurement
{
	...
	void AngleSceneView::notify( const Event::VTXEvent * const p_event )
	{
	...
	void AngleSceneView::_fillItemSelection( const Model::Selection & p_selection, QItemSelection & p_itemSelection )
	{
		std::set<Model::Label *> selectedLabels = std::set<Model::Label *>();
		p_selection.getItemsOfType( VTX::ID::Model::MODEL_MEASUREMENT_ANGLE, selectedLabels );
