...
namespace VTX::Tool::Analysis::StructuralAlignment::Core::Method
{
	...
	{
		windowSize = VTX::App::Old::Application::Setting::CE_ALIGN_WIN_SIZE_DEFAULT;
		gapMax	   = VTX::App::Old::Application::Setting::CE_ALIGN_GAP_MAX_DEFAULT;
		maxPath	   = VTX::App::Old::Application::Setting::CE_ALIGN_MAX_PATH_DEFAULT;
		d0		   = VTX::App::Old::Application::Setting::CE_ALIGN_D0_DEFAULT;
		d1		   = VTX::App::Old::Application::Setting::CE_ALIGN_D1_DEFAULT;
	}
	...
	std::vector<Vec3f> CEAlign::_generateResiduePositionsVector( const App::Old::Component::Chemistry::Molecule &  p_molecule,
																 const CustomParameters & p_parameters )
	{
		...
		{
			const App::Old::Component::Chemistry::Residue * const residuePtr = p_molecule.getResidue( iResidue );
	...
	Vec3f CEAlign::_computeResidueCenterOfMass( const App::Old::Component::Chemistry::Residue & p_residue )
	{
		// return _residuePositionsDataSet.getPositionInMolecule( p_residue );

		const App::Old::Component::Chemistry::Molecule &						molecule = *( p_residue.getMoleculePtr() );
		const App::Old::Component::Chemistry::Molecule::AtomPositionsFrame & atomPositions
	...
	float CEAlign::_computeRMSDOnAtomOfPath( const App::Old::Component::Chemistry::Molecule & p_staticMolecule,
											 ...
											 const Mat4f &			 p_transfoMatrix )
	{
		...
		for ( int i = 0; i < pathSize; i++ )
		{
			for ( int iWinSize = 0; iWinSize < p_windowSize; iWinSize++ )
			{
				...
				const App::Old::Component::Chemistry::Residue * const residue1 = p_staticMolecule.getResidue( iResidue1 );
				const App::Old::Component::Chemistry::Residue * const residue2 = p_mobileMolecule.getResidue( iResidue2 );
		...
		return float( VTX::Tool::Analysis::RMSD::Core::computeRMSD(
