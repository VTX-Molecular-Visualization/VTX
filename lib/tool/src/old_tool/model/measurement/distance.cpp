...
namespace VTX::Model::Measurement
{
	...
	bool Distance::_isLinkedToAtom( const App::Component::Chemistry::Atom * const p_atom ) const
	{
		if ( !isValid() )
			return false;
	...
	bool Distance::_isLinkedToMolecule( const App::Component::Chemistry::Molecule * const p_molecule ) const
	{
		if ( !isValid() )
			return false;
