...
namespace VTX::View::UI::Widget::Measurement
{
	DihedralAngleSceneView::DihedralAngleSceneView( Model::Measurement::DihedralAngle * const p_model,
		...
		App::Old::Core::View::BaseView<Model::Measurement::DihedralAngle>( p_model ),
		SceneItemWidget( p_parent )
	{
	}

	void DihedralAngleSceneView::notify( const App::Old::Core::Event::VTXEvent * const p_event )
	{
	...
	void DihedralAngleSceneView::_fillItemSelection( const App::Old::Application::Selection::SelectionModel & p_selection,
													 QItemSelection & p_itemSelection )
	{
		...
		p_selection.getItemsOfType( App::Old::ID::Model::MODEL_MEASUREMENT_DIHEDRAL_ANGLE, selectedLabels );
