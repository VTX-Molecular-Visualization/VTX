...
namespace VTX::View::UI::Widget::Measurement
{
	...
	void AngleSceneView::_fillItemSelection( const App::Application::Selection::SelectionModel & p_selection,
											 QItemSelection &									 p_itemSelection )
	{
		std::set<App::Component::Object3D::Label *> selectedLabels = std::set<App::Component::Object3D::Label *>();
		p_selection.getItemsOfType( App::ID::Model::MODEL_MEASUREMENT_ANGLE, selectedLabels );
