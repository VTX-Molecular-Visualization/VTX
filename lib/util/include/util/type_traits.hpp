...
namespace VTX
{
	...
	template<class T>
	constexpr bool is_vec2f_v = is_vec2f<T>::value;
	template<class T>
	constexpr bool is_vec2i_v = is_vec2i<T>::value;
	template<class T>
	constexpr bool is_vec3f_v = is_vec3f<T>::value;
	template<class T>
	constexpr bool is_vec3i_v = is_vec3i<T>::value;
	template<class T>
