...
if(NOT DEFINED _VTX_PYTHON_BINDING_CONAN)
	...
	pybind11_add_module(PyTX SHARED "${CMAKE_CURRENT_LIST_DIR}/../src/python_binding/binding/vtx_module.cpp")

	#target_link_libraries(PyTX PUBLIC vtx_util)
	#target_link_libraries(PyTX PUBLIC vtx_core)
	#target_link_libraries(PyTX PUBLIC vtx_app)
	#target_link_libraries(PyTX PUBLIC pybind11::pybind11)
	#target_link_libraries(PyTX PUBLIC pybind11::embed)
	target_link_libraries(PyTX PUBLIC vtx_python_binding)
else()
	...
	target_link_libraries(PyTX PRIVATE vtx_util::vtx_util)
	target_link_libraries(PyTX PRIVATE vtx_core::vtx_core)
	target_link_libraries(PyTX PRIVATE vtx_app::vtx_app)
