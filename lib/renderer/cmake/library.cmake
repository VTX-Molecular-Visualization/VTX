...
elseif(LINUX)
	...
	if(NOT TARGET wayland::wayland-egl)
		message(FATAL_ERROR "wayland::wayland-egl target is required. Install the Conan wayland package or enable Conan's CMakeDeps generator.")
	endif()
