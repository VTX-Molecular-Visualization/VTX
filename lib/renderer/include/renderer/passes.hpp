	...
	inline Pass descPassShading {
		...
		Programs {
			{ "Shading",
			  ...
			  BufferDataValues { {
				  { "Background color", E_TYPE::COLOR4, BufferValue<Util::Color::Rgba> { COLOR_BACKGROUND_DEFAULT } },
				  { "Light color", E_TYPE::COLOR4, BufferValue<Util::Color::Rgba> { COLOR_LIGHT_DEFAULT } },
				  { "Fog color", E_TYPE::COLOR4, BufferValue<Util::Color::Rgba> { COLOR_FOG_DEFAULT } },
				  { "Mode",
					E_TYPE::UINT,
					BufferValue<uint> {
