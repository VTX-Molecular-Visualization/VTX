#include "core/algorithm/solvent_excluded_surface.hpp"
...
namespace VTX::Core::Algorithm
{
	using Range = Struct::SolventExcludedSurface::Range;

	Struct::SolventExcludedSurface * SolventExcludedSurface::generate()
	{
		Struct::SolventExcludedSurface * const ses = new Struct::SolventExcludedSurface();
	...
	void SolventExcludedSurface::_init( Struct::SolventExcludedSurface & p_ses )
	{
