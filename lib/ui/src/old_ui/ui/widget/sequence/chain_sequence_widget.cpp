...
namespace VTX::UI::Widget::Sequence
{
	...
	App::Component::Chemistry::Residue * const ChainSequenceWidget::getFirstResidue() const
	{
		return _model->getMoleculePtr()->getResidue( _model->getIndexFirstResidue() );
	};
	App::Component::Chemistry::Residue * const ChainSequenceWidget::getLastResidue() const
	{
