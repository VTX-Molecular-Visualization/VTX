...
namespace VTX::UI::Widget::Settings
{
	...
	void RepresentationPresetEditor::_setupUi( const QString & p_name )
	{
		...
		Util::UI::fillComboBox( _cylinderColorBlendingMode, VTX::Core::ChemDB::Color::COLOR_BLENDING_MODE_STRING );
		...
		Util::UI::fillComboBox( _colorModeWidget, VTX::Core::ChemDB::Color::COLOR_MODE_STRING );
		...
		Util::UI::fillComboBox( _ribbonColorModeWidget, VTX::Core::ChemDB::Color::SECONDARY_STRUCTURE_COLOR_MODE_STRING );
		...
		Util::UI::fillComboBox( _ribbonColorBlendingMode, VTX::Core::ChemDB::Color::COLOR_BLENDING_MODE_STRING );
