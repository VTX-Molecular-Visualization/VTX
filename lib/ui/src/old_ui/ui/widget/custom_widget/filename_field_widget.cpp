...
namespace VTX::UI::Widget::CustomWidget
{
	...
	void FilenameFieldWidget::_setupUi( const QString & p_name )
	{
		...
		setMaxLength( App::Old::Internal::IO::Filesystem::MAX_FILE_LENGTH );

		QRegularExpressionValidator * const validator = new QRegularExpressionValidator(
			QRegularExpression( QString::fromStdString( App::Old::Internal::IO::Filesystem::REGEX_VALID_FILENAME ) ), this );
