...
{
	class TrajectoryWidget : public BaseManualWidget<QWidget>, public TMultiDataField<App::Old::Component::Chemistry::Molecule>
	{
		VTX_WIDGET
	  ...
	  public:
		...
		void updateWithNewValue( App::Old::Component::Chemistry::Molecule & p_value ) override;
	  ...
	  private:
		...
		std::unordered_set<App::Old::Component::Chemistry::Molecule *> _molecules = std::unordered_set<App::Old::Component::Chemistry::Molecule *>();
