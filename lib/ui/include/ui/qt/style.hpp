...
{
	inline static const std::string DEFAULT_STYLE_FACTORY = "windows";
	...
	class IconConst
	{
	  ...
	  private:
		IconConst() :
			...
			REPRESENTATION_STICK_AND_CARTOON_ICON( QPixmap( ":/sprite/representation_stick_and_cartoon_icon.png" ) ),
			...
			DIHEDRAL_ANGLE_RENDER_ICON_MASK(
				QT::Util::generateAlphaMask( ":/sprite/render/dihedral_angle_icon.png" ) ) {};
	};
