...
namespace VTX::UI::QT::Widget::Library
{
	class RenderSettings final : public BasePresetWidget<App::Library::Preset::RenderSettings>
	{
	  ...
	  private:
		...
		QPointer<Core::Widget::ColorPicker>		 _colorPickerBackground;
		QPointer<Core::Widget::ColorPicker>		 _colorPickerLight;
		...
		QPointer<Core::Widget::ColorPicker>		 _colorPickerOutline;
		...
		QPointer<Core::Widget::ColorPicker>		 _colorPickerFog;
		...
		QPointer<Core::Widget::ColorPicker>		 _colorPickerSelection;
