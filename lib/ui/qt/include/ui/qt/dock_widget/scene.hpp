...
namespace VTX::UI::QT::DockWidget
{
	...
	class Scene : public BaseDockWidget<Scene>
	{
	  ...
	  private:
		 ...
		 */
		std::unordered_map<App::Entity, QPointer<Widget::Tree::TrajectoryPlayer>> _mapTrajTreeWidgets;
		 ...
		 * @brief System trees.
		 */
		std::unordered_map<App::Entity, QPointer<Widget::Tree::System>> _mapSystemTreeWidgets;
		 ...
		 */
		void _onCameraConstruct( App::Registry &, App::Entity );
		 ...
		 */
		void _onUpdateVisibility( App::Registry &, App::Entity p_e );

		/**
		 * @brief Update selection.
		 */
		void _onUpdateSelection( App::Registry &, App::Entity p_e );
		 ...
		 */
		void _onTrajectoryCreated( App::Registry &, App::Entity p_entity );
