...
namespace VTX::UI::QT::Style::Icons
{
	...
	constexpr Codepoint CAMERA_SAVE_VIEWPOINT = 0xf40c;	 // VIDEO_CAMERA_BACK_ADD
	constexpr Codepoint CANCEL				  = 0xe5c9;	 // CANCEL
	constexpr Codepoint CATEGORY			  = 0xe574;	 // CATEGORY
	...
	constexpr Codepoint GPU					  = 0xe322;	 // MEMORY
	constexpr Codepoint INFO				  = 0xe88e;	 // INFO
	...
	constexpr Codepoint RESIDUE				  = 0xebc7;	 // ATR
