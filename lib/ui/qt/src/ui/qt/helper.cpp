...
namespace VTX::UI::QT::Helper
{
	...
	App::Core::Input::Key qKeyToKey( const Qt::Key & p_key )
	{
		static std::unordered_map<Qt::Key, App::Core::Input::Key> keyMap = {
			{ Qt::Key::Key_A, App::Core::Input::Key::Key_A },	  { Qt::Key::Key_B, App::Core::Input::Key::Key_B },
			{ Qt::Key::Key_C, App::Core::Input::Key::Key_C },	  { Qt::Key::Key_D, App::Core::Input::Key::Key_D },
			{ Qt::Key::Key_E, App::Core::Input::Key::Key_E },	  { Qt::Key::Key_F, App::Core::Input::Key::Key_F },
			{ Qt::Key::Key_G, App::Core::Input::Key::Key_G },	  { Qt::Key::Key_H, App::Core::Input::Key::Key_H },
			{ Qt::Key::Key_I, App::Core::Input::Key::Key_I },	  { Qt::Key::Key_J, App::Core::Input::Key::Key_J },
			{ Qt::Key::Key_K, App::Core::Input::Key::Key_K },	  { Qt::Key::Key_L, App::Core::Input::Key::Key_L },
			{ Qt::Key::Key_M, App::Core::Input::Key::Key_M },	  { Qt::Key::Key_N, App::Core::Input::Key::Key_N },
			{ Qt::Key::Key_O, App::Core::Input::Key::Key_O },	  { Qt::Key::Key_P, App::Core::Input::Key::Key_P },
			{ Qt::Key::Key_Q, App::Core::Input::Key::Key_Q },	  { Qt::Key::Key_R, App::Core::Input::Key::Key_R },
			{ Qt::Key::Key_S, App::Core::Input::Key::Key_S },	  { Qt::Key::Key_T, App::Core::Input::Key::Key_T },
			{ Qt::Key::Key_U, App::Core::Input::Key::Key_U },	  { Qt::Key::Key_V, App::Core::Input::Key::Key_V },
			{ Qt::Key::Key_W, App::Core::Input::Key::Key_W },	  { Qt::Key::Key_X, App::Core::Input::Key::Key_X },
			{ Qt::Key::Key_Y, App::Core::Input::Key::Key_Y },	  { Qt::Key::Key_Z, App::Core::Input::Key::Key_Z },
			{ Qt::Key::Key_0, App::Core::Input::Key::Key_0 },	  { Qt::Key::Key_1, App::Core::Input::Key::Key_1 },
			{ Qt::Key::Key_2, App::Core::Input::Key::Key_2 },	  { Qt::Key::Key_3, App::Core::Input::Key::Key_3 },
			{ Qt::Key::Key_4, App::Core::Input::Key::Key_4 },	  { Qt::Key::Key_5, App::Core::Input::Key::Key_5 },
			{ Qt::Key::Key_6, App::Core::Input::Key::Key_6 },	  { Qt::Key::Key_7, App::Core::Input::Key::Key_7 },
			{ Qt::Key::Key_8, App::Core::Input::Key::Key_8 },	  { Qt::Key::Key_9, App::Core::Input::Key::Key_9 },
			{ Qt::Key::Key_F1, App::Core::Input::Key::Key_F1 },	  { Qt::Key::Key_F2, App::Core::Input::Key::Key_F2 },
			{ Qt::Key::Key_F3, App::Core::Input::Key::Key_F3 },	  { Qt::Key::Key_F4, App::Core::Input::Key::Key_F4 },
			{ Qt::Key::Key_F5, App::Core::Input::Key::Key_F5 },	  { Qt::Key::Key_F6, App::Core::Input::Key::Key_F6 },
			{ Qt::Key::Key_F7, App::Core::Input::Key::Key_F7 },	  { Qt::Key::Key_F8, App::Core::Input::Key::Key_F8 },
			{ Qt::Key::Key_F9, App::Core::Input::Key::Key_F9 },	  { Qt::Key::Key_F10, App::Core::Input::Key::Key_F10 },
