...
namespace VTX::UI::QT::Tool::Scene::Widget::View
{
	MoleculeSceneView::MoleculeSceneView( App::Old::Component::Chemistry::Molecule * const p_model,
		...
		VTX::App::Old::Core::View::BaseView<App::Old::Component::Chemistry::Molecule>( p_model ),
		...
		if ( p_column == 0 )
		{
			if ( p_item == _getMoleculeTreeWidgetItem() )
			{
				...
				if ( itemTxt != _model->getDisplayName() )
				{
					...
					{
						VTX_ACTION( new VTX::App::Old::Action::Molecule::Rename( *_model, itemTxt ) );
					}
	...
	void MoleculeSceneView::_doEnableStateChangeAction( const QTreeWidgetItem * const p_item ) const
	{
		...
		const VTX::App::Old::Action::VISIBILITY_MODE visibilityMode
			= modelEnabled ? VTX::App::Old::Action::VISIBILITY_MODE::SHOW : VTX::App::Old::Action::VISIBILITY_MODE::HIDE;
		...
		if ( modelTypeId == App::Old::ID::Model::MODEL_MOLECULE )
		{
			...
			{
				VTX_ACTION( new VTX::App::Old::Action::Selection::ChangeVisibility(
					selection, model, modelTypeId, visibilityMode ) );
			}
			else
			{
				VTX_ACTION( new VTX::App::Old::Action::Molecule::ChangeVisibility( model, visibilityMode ) );
			}
		}
		else if ( modelTypeId == App::Old::ID::Model::MODEL_CATEGORY )
		{
			...
			{
				VTX_ACTION( new VTX::App::Old::Action::Category::ChangeVisibility( model, visibilityMode ) );
			}
		}
		else if ( modelTypeId == App::Old::ID::Model::MODEL_CHAIN )
		{
			...
			{
				VTX_ACTION( new VTX::App::Old::Action::Chain::ChangeVisibility( model, visibilityMode ) );
			}
		}
		else if ( modelTypeId == App::Old::ID::Model::MODEL_RESIDUE )
		{
			...
			{
				VTX_ACTION( new VTX::App::Old::Action::Residue::ChangeVisibility( model, visibilityMode ) );
			}
		}
		else if ( modelTypeId == App::Old::ID::Model::MODEL_ATOM )
		{
			...
			{
				VTX_ACTION( new VTX::App::Old::Action::Atom::ChangeVisibility( model, visibilityMode ) );
			}
		}
	}
