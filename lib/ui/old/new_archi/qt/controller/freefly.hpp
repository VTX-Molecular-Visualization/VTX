...
namespace VTX::UI::QT::Controller
{
	...
	{
	  public:
		explicit Freefly( App::Old::Component::Render::Camera & p_camera ) : BaseCameraController( p_camera ) {}

		const App::Old::VTX_ID getID() const override { return ID::Controller::FREEFLY; }
