...
{
	class MultipleViewpointWidget : public MultipleModelInspectorWidget<App::Old::Component::Object3D::Viewpoint>
	{
		VTX_WIDGET
	  ...
	  private:
		...
		void _onTransformChange( const App::Old::Internal::Math::Transform & ) const;
