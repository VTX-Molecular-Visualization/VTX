...
namespace VTX::Controller
{
	...
	void Picker::_performSelection( const Vec2i & p_ids ) const
	{
		...
		{
			VTX_ACTION( new App::Old::Action::Selection::ClearSelection(
	...
	bool Picker::_isTargetSelected( const Vec2i & p_ids ) const
	{
		...
		bool targetSelected = App::Old::Application::Selection::SelectionManager::get().getSelectionModel().isModelSelected(
	...
	void Picker::_selectItem( App::Old::Component::Chemistry::Atom & p_atomPicked ) const
	{
		...
		default:
			VTX_ACTION( new App::Old::Action::Selection::SelectAtom( selectionModel, p_atomPicked, appendToSelection ) );
			break;
		}
	}
							  ...
							  App::Old::Component::Chemistry::Atom & p_atomPicked2 ) const
	{
		...
		case VTX::App::Old::Application::Selection::GRANULARITY::MOLECULE:
		{
			...
			if ( mol1 == mol2 )
			{
				VTX_ACTION( new App::Old::Action::Selection::SelectMolecule( selectionModel, *mol1, appendToSelection ) );
			}
			else
			{
				VTX_ACTION(
					new App::Old::Action::Selection::SelectMolecule( selectionModel, { mol1, mol2 }, appendToSelection ) );
			}
			break;
		}
		case VTX::App::Old::Application::Selection::GRANULARITY::CHAIN:
		{
			...
			if ( chain1 == chain2 )
			{
				VTX_ACTION( new App::Old::Action::Selection::SelectChain( selectionModel, *chain1, appendToSelection ) );
			}
			else
			{
				VTX_ACTION(
					new App::Old::Action::Selection::SelectChain( selectionModel, { chain1, chain2 }, appendToSelection ) );
			}
			break;
		}
		case VTX::App::Old::Application::Selection::GRANULARITY::RESIDUE:
		{
			...
			if ( res1 == res2 )
			{
				VTX_ACTION( new App::Old::Action::Selection::SelectResidue( selectionModel, *res1, appendToSelection ) );
			}
			else
			{
				VTX_ACTION(
					new App::Old::Action::Selection::SelectResidue( selectionModel, { res1, res2 }, appendToSelection ) );
			}
			break;
		}
		case VTX::App::Old::Application::Selection::GRANULARITY::ATOM:
		default:
		{
			...
			{
				VTX_ACTION(
					new App::Old::Action::Selection::SelectAtom( selectionModel, p_atomPicked1, appendToSelection ) );
			}
			else
			{
				VTX_ACTION( new App::Old::Action::Selection::SelectAtom(
	...
	void Picker::_selectItem( App::Old::Component::Chemistry::Residue & p_residuePicked ) const
	{
		...
		default:
			VTX_ACTION(
				new App::Old::Action::Selection::SelectResidue( selectionModel, p_residuePicked, appendToSelection ) );
			break;
		}
	}
	...
	void Picker::_unselectItem( App::Old::Component::Chemistry::Atom & p_atomPicked ) const
	{
		...
		{
		case VTX::App::Old::Application::Selection::GRANULARITY::MOLECULE:
			VTX_ACTION( new App::Old::Action::Selection::UnselectMolecule(
				selectionModel, *p_atomPicked.getMoleculePtr(), appendToSelection ) );
			break;
		case VTX::App::Old::Application::Selection::GRANULARITY::CHAIN:
			VTX_ACTION( new App::Old::Action::Selection::UnselectChain(
				selectionModel, *p_atomPicked.getChainPtr(), appendToSelection ) );
			break;
		case VTX::App::Old::Application::Selection::GRANULARITY::RESIDUE:
		...
		case VTX::App::Old::Application::Selection::GRANULARITY::ATOM:
		default:
			VTX_ACTION( new App::Old::Action::Selection::UnselectAtom( selectionModel, p_atomPicked, appendToSelection ) );
			break;
		}
	}
								...
								App::Old::Component::Chemistry::Atom & p_atomPicked2 ) const
	{
		...
		case VTX::App::Old::Application::Selection::GRANULARITY::MOLECULE:
		{
			...
			if ( mol1 == mol2 )
			{
				VTX_ACTION( new App::Old::Action::Selection::UnselectMolecule( selectionModel, *mol1, appendToSelection ) );
			}
			else
			{
				VTX_ACTION(
					new App::Old::Action::Selection::UnselectMolecule( selectionModel, { mol1, mol2 }, appendToSelection ) );
			}
			break;
		}
		case VTX::App::Old::Application::Selection::GRANULARITY::CHAIN:
		{
			...
			if ( chain1 == chain2 )
			{
				VTX_ACTION( new App::Old::Action::Selection::UnselectChain( selectionModel, *chain1, appendToSelection ) );
			}
			else
			{
				VTX_ACTION( new App::Old::Action::Selection::UnselectChain(
		...
		case VTX::App::Old::Application::Selection::GRANULARITY::RESIDUE:
		{
			...
			if ( res1 == res2 )
			{
				VTX_ACTION( new App::Old::Action::Selection::UnselectResidue( selectionModel, *res1, appendToSelection ) );
			}
			else
			{
				VTX_ACTION(
					new App::Old::Action::Selection::UnselectResidue( selectionModel, { res1, res2 }, appendToSelection ) );
			}
		}
		break;
		case VTX::App::Old::Application::Selection::GRANULARITY::ATOM:
		default:
			...
			{
				VTX_ACTION(
					new App::Old::Action::Selection::UnselectAtom( selectionModel, p_atomPicked1, appendToSelection ) );
			}
			else
			{
				VTX_ACTION( new App::Old::Action::Selection::UnselectAtom(
					selectionModel, { &p_atomPicked1, &p_atomPicked2 }, appendToSelection ) );
			}
			break;
		}
	...
	void Picker::_unselectItem( App::Old::Component::Chemistry::Residue & p_residuePicked ) const
	{
		...
		default:
			VTX_ACTION(
				new App::Old::Action::Selection::UnselectResidue( selectionModel, p_residuePicked, appendToSelection ) );
			break;
		}
	}
