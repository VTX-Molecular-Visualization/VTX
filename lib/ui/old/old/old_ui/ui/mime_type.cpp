...
namespace VTX::UI
{
	MimeType::ModelData::ModelData( const App::Old::Core::Model::BaseModel & p_model, const DragSource & p_dragSource )
	{
	...
	QMimeData * const MimeType::generateMimeDataFromModel( const App::Old::Core::Model::BaseModel & p_model,
