...
namespace VTX::UI::Widget::Sequence::Dataset
{
	class SequenceDisplayDataset
	{
	  public:
		...
		virtual App::Old::Component::Chemistry::Residue * const getResidueAtCharIndex( const uint p_charIndex ) { return nullptr; };
		...
		virtual App::Old::Component::Chemistry::Residue * const getFirstResidue() const { return nullptr; };
		virtual App::Old::Component::Chemistry::Residue * const getLastResidue() const { return nullptr; };
