...
namespace VTX::UI::Widget::Sequence::Dataset
{
	...
	{
	  public:
		SequenceDisplayDataset_ResidueWithSameId( const App::Old::Component::Chemistry::Chain & p_chain,
		...
		App::Old::Component::Chemistry::Residue * const getResidueAtCharIndex( const uint p_charIndex ) override;
		...
		App::Old::Component::Chemistry::Residue * const getFirstResidue() const override
		{
			return _linkedChain.getMoleculePtr()->getResidue( _linkedChain.getIndexFirstResidue()
															  + _startResidueIndex );
		};
		App::Old::Component::Chemistry::Residue * const getLastResidue() const override
		{
	  ...
	  private:
		const App::Old::Component::Chemistry::Chain & _linkedChain;
