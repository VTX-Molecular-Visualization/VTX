...
{
	class ContextualMenuAtom : public ContextualMenuTemplate<App::Old::Component::Chemistry::Atom>
	{
		VTX_WIDGET
	  ...
	  public:
		...
		void setTarget( App::Old::Component::Chemistry::Atom * const p_target ) override;
