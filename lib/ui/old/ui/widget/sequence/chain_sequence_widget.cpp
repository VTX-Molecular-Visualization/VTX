...
namespace VTX::UI::Widget::Sequence
{
	...
	App::Old::Component::Chemistry::Residue * const ChainSequenceWidget::getResidueAtPos( const QPoint & p_pos ) const
	{
	...
	App::Old::Component::Chemistry::Residue * const ChainSequenceWidget::getFirstResidue() const
	{
		return _model->getMoleculePtr()->getResidue( _model->getIndexFirstResidue() );
	};
	App::Old::Component::Chemistry::Residue * const ChainSequenceWidget::getLastResidue() const
	{
		return _model->getMoleculePtr()->getResidue( _model->getIndexLastResidue() );
	};

	App::Old::Component::Chemistry::Residue & ChainSequenceWidget::getClosestResidueFromPos( const QPoint & p_pos,
