#include "ui/old_ui/ui/widget/sequence/dataset/sequence_dataset_residue_with_same_id.hpp"
#include "ui/old_ui/style.hpp"

namespace VTX::UI::Widget::Sequence::Dataset
{
	SequenceDisplayDataset_ResidueWithSameId::SequenceDisplayDataset_ResidueWithSameId( const App::Old::Component::Chemistry::Chain & p_chain,
	...
	App::Old::Component::Chemistry::Residue * const SequenceDisplayDataset_ResidueWithSameId::getResidueAtCharIndex( const uint p_charIndex )
	{
