...
{
	class ContextualMenuViewpoint : public ContextualMenuTemplate<App::Old::Component::Object3D::Viewpoint>
	{
		VTX_WIDGET
	  ...
	  public:
		...
		void setTarget( App::Old::Component::Object3D::Viewpoint * const p_target ) override;
