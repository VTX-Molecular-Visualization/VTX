...
namespace VTX::App::Old::Internal::IO::Serialization
{
	...
	ScenePathData::Data & ScenePathData::getData( const App::Old::Component::Chemistry::Molecule * const p_molecule )
	{
		return _mapMoleculePath[ p_molecule ];
	}
	const ScenePathData::Data & ScenePathData::getData(
		const App::Old::Component::Chemistry::Molecule * const p_molecule ) const
	{
	...
	ScenePathData::ScenePathData() : App::Old::Core::Event::BaseEventReceiverVTX()
	{
		_registerEvent( VTX::App::Old::Event::Global::MOLECULE_ADDED );
		_registerEvent( VTX::App::Old::Event::Global::MOLECULE_REMOVED );
		_registerEvent( VTX::App::Old::Event::Global::MOLECULE_STRUCTURE_CHANGE );
		_registerEvent( VTX::App::Old::Event::Global::SCENE_SAVED );
		_registerEvent( VTX::App::Old::Event::Global::SCENE_PATH_CHANGE );
	}

	void ScenePathData::receiveEvent( const App::Old::Core::Event::VTXEvent & p_event )
	{
		if ( p_event.name == VTX::App::Old::Event::Global::MOLECULE_ADDED )
		{
			const App::Old::Component::Chemistry::Molecule * const molecule
		...
		else if ( p_event.name == VTX::App::Old::Event::Global::MOLECULE_STRUCTURE_CHANGE )
		{
			const App::Old::Component::Chemistry::Molecule * const molecule
				= dynamic_cast<const App::Old::Core::Event::VTXEventArg<App::Old::Component::Chemistry::Molecule *> &>( p_event )
					  .get();
		...
		else if ( p_event.name == VTX::App::Old::Event::Global::SCENE_SAVED
				  || p_event.name == VTX::App::Old::Event::Global::SCENE_PATH_CHANGE )
		{
			resetSceneModifications();
		}
	}

	void ScenePathData::registerLoading( const App::Old::Component::Chemistry::Molecule * const p_molecule,
	...
	void ScenePathData::setCurrentPath( const FilePath & p_filePath, const bool p_addInRecentPath )
	{
		...
		if ( p_addInRecentPath )
			VTX::App::Old::Application::Setting::enqueueNewLoadingPath( p_filePath );

		VTX_EVENT<const FilePath &>( VTX::App::Old::Event::Global::SCENE_PATH_CHANGE, _currentFilePath );
	}
	...
	FilePath ScenePathData::getFilepath( const App::Old::Component::Chemistry::Molecule * const p_molecule ) const
	{
		FilePath res;
		...
		const FilePath	  moleculeFolderPath = App::Old::Internal::IO::Filesystem::getSceneSaveDirectory( _currentFilePath );
	...
	void ScenePathData::incrementSceneModifications()
	{
		...
		if ( _sceneModificationsCount == 0 )
			VTX_EVENT<bool>( VTX::App::Old::Event::Global::SCENE_MODIFICATION_STATE_CHANGE, false );
		else if ( _sceneModificationsCount == 1 )
			VTX_EVENT<bool>( VTX::App::Old::Event::Global::SCENE_MODIFICATION_STATE_CHANGE, true );
	}
