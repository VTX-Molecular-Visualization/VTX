#ifndef __VTX_APP_OLD_RENDER_RENDERER_RT_BRDF_COOK_TORRANCE__
#define __VTX_APP_OLD_RENDER_RENDERER_RT_BRDF_COOK_TORRANCE__
...
namespace VTX::App::Old::Render::Renderer::RT::BRDF
{
	namespace CookTorrance
	{
									 ...
									 const float			   p_shininess )
		{
			...
			const Util::Color::Rgba F		= p_f0 + ( 1.f - p_f0 ) * _IdotH2 * _IdotH2 * _IdotH;
