#ifndef __VTX_APP_OLD_RENDER_RENDERER_RT_BASE_PRIMITIVE__
#define __VTX_APP_OLD_RENDER_RENDERER_RT_BASE_PRIMITIVE__
...
namespace VTX::App::Old::Render::Renderer::RT::Primitive
{
	class BasePrimitive : public BaseObject3D
	{
	  public:
		...
		const App::Old::Component::Object3D::Helper::AABB & getAABB() const { return _aabb; }
