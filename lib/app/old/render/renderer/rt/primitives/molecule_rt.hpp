#ifndef __VTX_APP_OLD_RENDER_RENDERER_RT_MOLECULE_RT__
#define __VTX_APP_OLD_RENDER_RENDERER_RT_MOLECULE_RT__
...
namespace VTX::App::Old::Render::Renderer::RT::Primitive
{
	...
	{
	  public:
		MoleculeRT( const App::Old::Component::Chemistry::Molecule * p_molecule );
		~MoleculeRT()
		{
