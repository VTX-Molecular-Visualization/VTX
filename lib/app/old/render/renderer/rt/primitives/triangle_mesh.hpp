#ifndef __VTX_APP_OLD_RENDER_RENDERER_RT_TRIANGLE_MESH__
#define __VTX_APP_OLD_RENDER_RENDERER_RT_TRIANGLE_MESH__
...
namespace VTX::App::Old::Render::Renderer::RT::Primitive
{
	...
	class TriangleMesh : public BaseObject3D
	{
	  public:
		...
		// explicit TriangleMesh( const App::Old::Component::Chemistry::Molecule * p_molecule );
