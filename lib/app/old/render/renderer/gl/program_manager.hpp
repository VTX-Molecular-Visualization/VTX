#ifndef __VTX_APP_OLD_RENDER_GL_PROGRAM_MANAGER__
#define __VTX_APP_OLD_RENDER_GL_PROGRAM_MANAGER__
...
namespace VTX
{
	namespace App::Old::Render::Renderer::GL
	{
	...
	inline App::Old::Render::Renderer::GL::ProgramManager & VTX_PROGRAM_MANAGER()
	{
		return App::Old::Render::Renderer::GL::ProgramManager::get();
	}
} // namespace VTX
