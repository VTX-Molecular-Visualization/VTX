#ifndef __VTX_APP_OLD_RENDER_GL_VERETX_ARRAY__
#define __VTX_APP_OLD_RENDER_GL_VERETX_ARRAY__
...
namespace VTX::App::Old::Render::Renderer::GL
{
	...
	class VertexArray : public Render::Generic::BaseOpenGL
	{
	  public:
		...
		inline void create()
		{ /*_gl->glCreateVertexArrays( 1, &_id );*/
		}
		inline void destroy()
		{ /*_gl->glDeleteVertexArrays( 1, &_id );*/
		}

		inline GLuint getId() const { return _id; }

		inline void bind() const
		{ /*_gl->glBindVertexArray( _id );*/
		}
...
#endif // __VTX_APP_OLD_RENDER_GL_VERETX_ARRAY__
