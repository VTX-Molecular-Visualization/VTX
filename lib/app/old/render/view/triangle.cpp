...
namespace VTX::App::Old::Render::View
{
	...
	void Triangle::render( const App::Old::Component::Render::Camera & p_camera ) const
	{
	...
	void TriangleSES::render( const App::Old::Component::Render::Camera & p_camera ) const
	{
		BaseView3D::render( p_camera );
			  ...
			  _model->getCategory()->getMolecule()->getRepresentationData() )
		{
			...
			{
				const App::Old::Application::Representation::Primitive::SES & triangleData
					= representationData.first->getSESData();
