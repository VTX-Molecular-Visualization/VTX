#ifndef __VTX_APP_OLD_RENDER_WORKER_GPU_COMPUTER__
#define __VTX_APP_OLD_RENDER_WORKER_GPU_COMPUTER__
...
{
	class GpuComputer : public App::Old::Core::Worker::BaseWorker, public Render::Generic::BaseOpenGL
	{
	  public:
		...
		inline App::Old::Render::Renderer::GL::Program & getProgram() { return *_program; }
	  ...
	  protected:
		App::Old::Render::Renderer::GL::Program * _program;
		Vec3i								 _size;
