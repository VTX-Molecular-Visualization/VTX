...
{
	RenderEffectPreset::RenderEffectPreset() : BaseModel( App::Old::ID::Model::MODEL_RENDERER_RENDER_EFFECT_PRESET )
	{
		_shading = VTX::App::Old::Application::Setting::SHADING_DEFAULT;

		_ssao		   = VTX::App::Old::Application::Setting::ACTIVE_AO_DEFAULT;
		_ssaoIntensity = VTX::App::Old::Application::Setting::AO_INTENSITY_DEFAULT;
		_ssaoBlurSize  = VTX::App::Old::Application::Setting::AO_BLUR_SIZE_DEFAULT;

		_outline		  = VTX::App::Old::Application::Setting::ACTIVE_OUTLINE_DEFAULT;
		_outlineThickness = VTX::App::Old::Application::Setting::OUTLINE_THICKNESS_DEFAULT;
		_outlineSensivity = VTX::App::Old::Application::Setting::OUTLINE_SENSIVITY_DEFAULT;
		_outlineColor	  = VTX::App::Old::Application::Setting::OUTLINE_COLOR_DEFAULT;

		_fog		= VTX::App::Old::Application::Setting::ACTIVE_FOG_DEFAULT;
		_fogNear	= VTX::App::Old::Application::Setting::FOG_NEAR_DEFAULT;
		_fogFar		= VTX::App::Old::Application::Setting::FOG_FAR_DEFAULT;
		_fogDensity = VTX::App::Old::Application::Setting::FOG_DENSITY_DEFAULT;
		_fogColor	= VTX::App::Old::Application::Setting::FOG_COLOR_DEFAULT;

		_backgroundColor  = VTX::App::Old::Application::Setting::BACKGROUND_COLOR_DEFAULT;
		_cameraLightColor = VTX::App::Old::Application::Setting::LIGHT_COLOR_DEFAULT;
	}
	...
	void RenderEffectPreset::setSSAOIntensity( const int p_ssaoIntensity )
	{
		_ssaoIntensity = Util::Math::clamp( p_ssaoIntensity,
											VTX::App::Old::Application::Setting::AO_INTENSITY_MIN,
	...
	void RenderEffectPreset::setSSAOBlurSize( const int p_ssaoBlurSize )
	{
		_ssaoBlurSize = Util::Math::clamp( p_ssaoBlurSize,
										   VTX::App::Old::Application::Setting::AO_BLUR_SIZE_MIN,
	...
	void RenderEffectPreset::setOutlineThickness( const uint p_outlineThickness )
	{
		_outlineThickness = Util::Math::clamp( p_outlineThickness,
											   VTX::App::Old::Application::Setting::OUTLINE_THICKNESS_MIN,
	...
	void RenderEffectPreset::setOutlineSensivity( const float p_outlineSensivity )
	{
		_outlineSensivity = Util::Math::clamp( p_outlineSensivity,
											   VTX::App::Old::Application::Setting::OUTLINE_SENSIVITY_MIN,
