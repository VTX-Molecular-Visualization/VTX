#ifndef __VTX_APP_OLD_APPLICATION_RENDER_EFFECT_RENDER_EFFECT_PRESET__
#define __VTX_APP_OLD_APPLICATION_RENDER_EFFECT_RENDER_EFFECT_PRESET__
...
{
	class RenderEffectPreset : public App::Old::Core::Model::BaseModel
	{
		VTX_MODEL
