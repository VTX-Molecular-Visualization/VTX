#ifndef __VTX_APP_OLD_APPLICATION_SETTING__
#define __VTX_APP_OLD_APPLICATION_SETTING__
...
namespace VTX::App::Old::Application
{
	class Setting
	{
	  public:
		...
		static const App::Old::VTX_ID CONTROLLER_MODE_DEFAULT;
		static const App::Old::VTX_ID PICKER_MODE_DEFAULT;
		...
		void setSnapshotResolution( const Internal::IO::Serialization::ImageExport::RESOLUTION & p_snapshotResolution );
