#ifndef __VTX_APP_OLD_COMPONENT_CHEMISTRY_GENERATED_MOLECULE__
#define __VTX_APP_OLD_COMPONENT_CHEMISTRY_GENERATED_MOLECULE__
...
namespace VTX::App::Old::Component::Chemistry
{
	class GeneratedMolecule : public Molecule
	{
	  ...
	  public:
		void copyFromSelection( const App::Old::Application::Selection::SelectionModel & p_selection,
								const App::Old::Core::Model::ID &						p_moleculeID,
		...
		void extractFromSelection( const App::Old::Application::Selection::SelectionModel & p_selection,
								   const App::Old::Core::Model::ID &						   p_moleculeID );
