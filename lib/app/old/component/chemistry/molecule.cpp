...
#include "app/old/util/secondary_structure.hpp"
...
namespace VTX::App::Old::Component::Chemistry
{
	...
	Molecule::Molecule() : Molecule( App::Old::ID::Model::MODEL_MOLECULE ) {}
	Molecule::Molecule( const VTX::App::Old::VTX_ID & p_typeId ) : BaseModel3D( App::Old::ID::Model::MODEL_MOLECULE )
	{
		...
		if ( getFrameCount() > 0 )
		{
			...
			if ( !hasCustomRepresentation() )
			{
				...
				for ( Chemistry::Category * const category : getCategories() )
				{
					...
					const App::Old::Application::Representation::RepresentationPreset * const defaultRepresentation
						= App::Old::VTXApp::get().getRepresentationLibrary().getDefaultRepresentation(
	...
	void Molecule::clearDefaultRepresentations()
	{
		...
		for ( const App::Old::Core::Model::ID & instantiatedRepresentationID : _defaultRepresentationIDs )
		{
			...
			App::Old::Application::Representation::InstantiatedRepresentation & instantiatedRepresentation
				= VTX::MVC_MANAGER().getModel<App::Old::Application::Representation::InstantiatedRepresentation>(
	...
	bool Molecule::isDefaultRepresentation(
		const App::Old::Application::Representation::InstantiatedRepresentation & p_representation ) const
	{
	...
	void Molecule::_onRepresentationChange() { _notifyViews( App::Old::Event::Model::REPRESENTATION_CHANGE ); }
	...
	void Molecule::_fillBufferAtomColors()
	{
		...
		for ( const Chemistry::Residue * const residue : getResidues() )
		{
			...
			const App::Old::Application::Representation::InstantiatedRepresentation * const currentRepresentation
			...
			if ( colorMode == VTX::Core::ChemDB::Color::COLOR_MODE::INHERITED )
			{
				...
				else
				{
					...
					if ( moleculeColorMode != VTX::Core::ChemDB::Color::COLOR_MODE::INHERITED )
						...
						colorMode = VTX::App::Old::Application::Setting::COLOR_MODE_DEFAULT;
				}
			}
	...
	void Molecule::_fillBufferAtomSelections(
		const App::Old::Application::Selection::SelectionModel::MapChainIds * const p_selection )
	{
		...
		if ( p_selection != nullptr )
		{
			...
			{
				for ( const App::Old::Application::Selection::SelectionModel::PairChainIds & pairChain : *p_selection )
				{
	...
	void Molecule::setFrame( const uint p_frameIdx )
	{
		...
		_notifyViews( App::Old::Event::Model::TRAJECTORY_FRAME_CHANGE );
	...
	void Molecule::setFPS( const uint p_fps )
	{
		...
		{
			_fps = p_fps;
			_notifyViews( App::Old::Event::Model::TRAJECTORY_DATA_CHANGE );
		}
	}
	...
	void Molecule::forceNotifyTrajectoryChanged() { _notifyViews( App::Old::Event::Model::TRAJECTORY_DATA_CHANGE ); }
	...
	{
		Util::App::Old::Molecule::show( getCategory( ChemDB::Category::TYPE::WATER ), p_showWater );
		_fillBufferAtomVisibilities();
		VTX_EVENT( VTX::App::Old::Event::Global::MOLECULE_ELEMENT_DISPLAY_CHANGE );
	}
	...
	{
		Util::App::Old::Molecule::show( getCategory( ChemDB::Category::TYPE::SOLVENT ), p_showSolvent );
		_fillBufferAtomVisibilities();
		VTX_EVENT( VTX::App::Old::Event::Global::MOLECULE_ELEMENT_DISPLAY_CHANGE );
	}
	...
	{
		Util::App::Old::Molecule::show( getCategory( ChemDB::Category::TYPE::ION ), p_showIon );
		_fillBufferAtomVisibilities();
		VTX_EVENT( VTX::App::Old::Event::Global::MOLECULE_ELEMENT_DISPLAY_CHANGE );
	}
	...
	void Molecule::render( const App::Old::Component::Render::Camera & p_camera ) const
	{
	...
	void Molecule::createSecondaryStructure()
	{
		...
		{
			Util::App::Old::SecondaryStructure::computeSecondaryStructure( *this );
		}
	...
	void Molecule::setVisible( const bool p_visible )
	{
		...
		{
			_notifyViews( App::Old::Event::Model::MOLECULE_VISIBILITY );
		}
	}
	...
	void Molecule::removeChain( const uint p_id, const bool p_delete, const bool p_recursive, const bool p_notifyViews )
	{
		...
		VTX_EVENT<Chemistry::Chain *>( VTX::App::Old::Event::Global::CHAIN_REMOVED, chainToDelete );
								  ...
								  const bool p_notifyViews )
	{
		...
		VTX_EVENT<Chemistry::Residue *>( VTX::App::Old::Event::Global::RESIDUE_REMOVED, residueToDelete );
							   ...
							   const bool p_notifyViews )
	{
		...
		VTX_EVENT<Chemistry::Atom *>( VTX::App::Old::Event::Global::ATOM_REMOVED, atomToDelete );
