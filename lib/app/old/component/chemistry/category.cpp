...
namespace VTX::App::Old::Component::Chemistry
{
	...
	void Category::setVisible( const bool p_visible )
	{
	 ...
	 Component::Generic::BaseVisible::setVisible( p_visible );
		...
		{
			_notifyViews<ChemDB::Category::TYPE>( App::Old::Event::Model::CATEGORY_VISIBILITY, _category );
			_moleculePtr->propagateEventToViews<ChemDB::Category::TYPE>( App::Old::Event::Model::CATEGORY_VISIBILITY,
																		 _category );
		}
	}
	...
	const App::Old::Component::Object3D::Helper::AABB Category::getAABB() const
	{
	...
	const App::Old::Component::Object3D::Helper::AABB Category::getWorldAABB() const
	{
	...
	void Category::_onRepresentationChange() { _notifyViews( App::Old::Event::Model::REPRESENTATION_CHANGE ); }
