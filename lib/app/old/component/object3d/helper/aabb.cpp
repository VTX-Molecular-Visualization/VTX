...
namespace VTX::App::Old::Component::Object3D::Helper
{
	...
	void AABB::refresh()
	{
		...
		_vbo.set<Vec3f>( corners, App::Old::Render::Renderer::GL::Buffer::Usage::STATIC_DRAW );
	...
	void AABB::_generate()
	{
		_program = VTX_PROGRAM_MANAGER().createProgram(
			"Line", { FilePath( "line/line.vert" ), FilePath( "line/line.frag" ) } );
		...
		_vao.setAttributeFormat(
			ATTRIBUTE_LOCATION::AABB_CORNER, 3, App::Old::Render::Renderer::GL::VertexArray::Type::FLOAT );
		_vao.setAttributeBinding( ATTRIBUTE_LOCATION::AABB_CORNER, ATTRIBUTE_LOCATION::AABB_CORNER );

		refresh();
	}

	void AABB::render( const App::Old::Component::Render::Camera & p_camera ) const
	{
		_program->use();
		...
		_vao.bind();
		_vao.drawElement( App::Old::Render::Renderer::GL::VertexArray::DrawMode::LINES,
						  GLsizei( _iboSize ),
						  App::Old::Render::Renderer::GL::VertexArray::Type::UNSIGNED_INT );
		_vao.unbind();
	}
} // namespace VTX::App::Old::Component::Object3D::Helper
