...
{
	Label::Label( const VTX::App::Old::VTX_ID & p_typeId ) : BaseModel( p_typeId )
	{
		const std::string *& namePtr = _getNamePtr();
		namePtr						 = &_name;
		_color						 = VTX::App::Old::Application::Setting::DEFAULT_LABEL_COLOR;
	};
	Label::Label() : Label( App::Old::ID::Model::MODEL_LABEL ) {};
	...
	const App::Old::Component::Object3D::Helper::AABB & Label::getAABB()
	{
		if ( !_aabb.isValid() )
	...
	void Label::_recomputeAABB( App::Old::Component::Object3D::Helper::AABB & p_aabb )
	{
