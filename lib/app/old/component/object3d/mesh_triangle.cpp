...
{
	MeshTriangle::MeshTriangle() : BaseModel3D( App::Old::ID::Model::MODEL_MESH_TRIANGLE ) {}
	...
	{
		_addRenderable(
			VTX::MVC_MANAGER().instantiateView<App::Old::Render::View::Triangle>( this, VTX::App::Old::ID::View::D3_TRIANGLE ) );
	}
