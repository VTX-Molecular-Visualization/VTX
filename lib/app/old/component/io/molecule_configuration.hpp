#ifndef __VTX_APP_OLD_COMPONENT_IO_MOLECULE_CONFIGURATION__
#define __VTX_APP_OLD_COMPONENT_IO_MOLECULE_CONFIGURATION__

#include <set>
#include <string>
#include <util/types.hpp>

namespace VTX::App::Old::Component::IO
{
