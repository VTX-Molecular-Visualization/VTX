...
#include "app/render/renderer/rt/materials/metal.hpp"
...
namespace VTX::App::Render::Renderer::RT::Primitive
{
	MoleculeRT::MoleculeRT( const App::Component::Chemistry::Molecule * p_molecule )
	{
		...
		if ( rep == App::Application::Representation::REPRESENTATION_ENUM::BALL_AND_STICK
			 || rep == App::Application::Representation::REPRESENTATION_ENUM::STICK )
		{
		...
		std::map<App::Component::Chemistry::Chain *, Material::BaseMaterial *> mapMtls;
			...
			if ( p_molecule->isAtomVisible( i ) )
			{
				...
				primitives.emplace_back(
					new Primitive::Sphere( tAtomPositions[ i ],
										   rep == App::Application::Representation::REPRESENTATION_ENUM::VAN_DER_WAALS
											   ? p_molecule->getAtomRadius( i )
										   : rep == App::Application::Representation::REPRESENTATION_ENUM::SAS
