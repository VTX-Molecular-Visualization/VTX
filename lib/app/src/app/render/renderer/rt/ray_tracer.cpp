...
#include "app/render/renderer/rt/lights/directional_light.hpp"
#include "app/render/renderer/rt/lights/point_light.hpp"
#include "app/render/renderer/rt/lights/quad_light.hpp"
#include "app/render/renderer/rt/materials/flat_color_material.hpp"
#include "app/render/renderer/rt/materials/matte.hpp"
#include "app/render/renderer/rt/primitives/cylinder.hpp"
#include "app/render/renderer/rt/primitives/molecule_rt.hpp"
...
namespace VTX::App::Render::Renderer::RT
{
	...
	void RayTracer::init( const uint p_width, const uint p_height, const GLuint p_outputFramebufferId )
	{
		...
		_texture.create( p_width,
						 p_height,
						 App::Render::Renderer::GL::Texture2D::InternalFormat::RGB16F,
						 App::Render::Renderer::GL::Texture2D::Wrapping::CLAMP_TO_EDGE,
						 App::Render::Renderer::GL::Texture2D::Wrapping::CLAMP_TO_EDGE,
						 App::Render::Renderer::GL::Texture2D::Filter::NEAREST,
						 App::Render::Renderer::GL::Texture2D::Filter::NEAREST );

		getOutputFramebuffer().attachTexture( _texture, App::Render::Renderer::GL::Framebuffer::Attachment::COLOR0 );
	...
	void RayTracer::renderFrame( const App::Application::Scene & p_scene )
	{
		...
		_texture.fill( _pixels.data(),
					   App::Render::Renderer::GL::Texture2D::Format::RGB,
					   App::Render::Renderer::GL::Texture2D::Type::FLOAT );

		getOutputFramebuffer().bind();
		getOutputFramebuffer().setDrawBuffers( { App::Render::Renderer::GL::Framebuffer::Attachment::COLOR0 } );
...
#else
		for ( const std::pair<const App::Component::Chemistry::Molecule * const, float> & pairMol :
