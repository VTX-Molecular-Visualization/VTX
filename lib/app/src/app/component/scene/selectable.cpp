...
namespace VTX::App::Component::Scene
{
	...
	std::unique_ptr<Selection::SelectionData> Selectable::instantiateSelectionData() const
	{
		return _selectionDataGenerator();
	}

	std::unique_ptr<Selection::SelectionData> Selectable::_defaultSelectionDataGenerator()
	{
		return std::move( std::make_unique<Selection::SelectionData>( *this ) );
	}
