...
namespace VTX::App::Application::Representation
{
	...
	{
		App::Core::View::CallbackView<const RepresentationPreset, RepresentationManager> * const view
			= VTX::MVC_MANAGER()
				  .instantiateView<App::Core::View::CallbackView<const RepresentationPreset, RepresentationManager>>(
