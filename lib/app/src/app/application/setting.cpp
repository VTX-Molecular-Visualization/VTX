...
namespace VTX::App::Application
{
	...
	const Component::Chemistry::PlayMode Setting::DEFAULT_TRAJECTORY_PLAY_MODE = Component::Chemistry::PlayMode::Loop;
	...
	{
		accelerationFactorSpeed = Util::Math::clamp(
			p_factorSpeed, Setting::CONTROLLER_ACCELERATION_FACTOR_MIN, Setting::CONTROLLER_ACCELERATION_FACTOR_MAX );
	...
	{
		decelerationFactorSpeed = Util::Math::clamp(
			p_factorSpeed, Setting::CONTROLLER_DECELERATION_FACTOR_MIN, Setting::CONTROLLER_DECELERATION_FACTOR_MAX );
	...
	void Setting::setRotationSpeed( const float p_rotationSpeed )
	{
		rotationSpeed = Util::Math::clamp(
			p_rotationSpeed, Setting::CONTROLLER_ROTATION_SPEED_MIN, Setting::CONTROLLER_ROTATION_SPEED_MAX );
	...
	void Setting::setDefaultTrajectorySpeed( const int p_defaultTrajectorySpeed )
	{
		defaultTrajectorySpeed = Util::Math::clamp(
			p_defaultTrajectorySpeed, Setting::MIN_TRAJECTORY_SPEED, Setting::MAX_TRAJECTORY_SPEED );
		_sendDataChangedEvent( PARAMETER::TRAJECTORY_DEFAULT_SPEED );
	}
	void Setting::setDefaultTrajectoryPlayMode( const Component::Chemistry::PlayMode p_defaultTrajectoryPlayMode )
	{
	...
	void Setting::restore()
	{
		...
		representationDefaultIndex
			= Application::Representation::RepresentationManager::get().getDefaultRepresentationIndex();
