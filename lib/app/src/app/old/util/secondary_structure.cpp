...
namespace VTX::Util::App::Old::SecondaryStructure
{
	...
	{
		const VTX::App::Old::Component::Chemistry::Molecule::AtomPositionsFrame & positions
			= p_molecule.getAtomPositionFrame( p_molecule.getFrame() );

		for ( uint chainIdx = 0; chainIdx < p_molecule.getChainCount(); ++chainIdx )
		{
			const VTX::App::Old::Component::Chemistry::Chain * const chainPtr = p_molecule.getChain( chainIdx );

			if ( chainPtr == nullptr )
				continue;

			const VTX::App::Old::Component::Chemistry::Chain & chain		   = *chainPtr;
			...
			for ( uint residueIdx = 1; residueIdx < residueCount - 1; ++residueIdx )
			{
				...
				const VTX::App::Old::Component::Chemistry::Residue * const residue0Ptr
					= p_molecule.getResidue( currentResidueIndex - 1 );
				VTX::App::Old::Component::Chemistry::Residue * const residue1Ptr
					= p_molecule.getResidue( currentResidueIndex );
				const VTX::App::Old::Component::Chemistry::Residue * const residue2Ptr
					= p_molecule.getResidue( currentResidueIndex + 1 );
				...
				const VTX::App::Old::Component::Chemistry::Residue & residue0 = *residue0Ptr;
				VTX::App::Old::Component::Chemistry::Residue &		residue1 = *residue1Ptr;
				const VTX::App::Old::Component::Chemistry::Residue & residue2 = *residue2Ptr;

				residue1.setSecondaryStructure( ChemDB::SecondaryStructure::TYPE::COIL );

				const VTX::App::Old::Component::Chemistry::Atom * C0	 = residue0.findFirstAtomByName( "C" );
				const VTX::App::Old::Component::Chemistry::Atom * N1	 = residue1.findFirstAtomByName( "N" );
				const VTX::App::Old::Component::Chemistry::Atom * CA1 = residue1.getAlphaCarbon();
				const VTX::App::Old::Component::Chemistry::Atom * C1	 = residue1.findFirstAtomByName( "C" );
				const VTX::App::Old::Component::Chemistry::Atom * N2	 = residue2.findFirstAtomByName( "N" );
			...
			for ( uint residueIdx = 0; residueIdx < residueCount; ++residueIdx )
			{
				...
				else
				{
					if ( 3 <= RHelixCount )
					{
						...
						{
							VTX::App::Old::Component::Chemistry::Residue & residue
			...
			for ( uint residueIdx = 1; residueIdx < residueCount - 1; ++residueIdx )
			{
				...
				const VTX::App::Old::Component::Chemistry::Residue & residue0 = *residue0Ptr;
				VTX::App::Old::Component::Chemistry::Residue &		residue	 = *residue1Ptr;
				const VTX::App::Old::Component::Chemistry::Residue & residue2 = *residue2Ptr;
