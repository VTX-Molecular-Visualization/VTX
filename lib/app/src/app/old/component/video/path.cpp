...
{
	Path::Path() : BaseModel( App::Old::ID::Model::MODEL_PATH ) {};
	...
	void Path::addViewpoint( Object3D::Viewpoint * const p_viewpoint )
	{
		...
		VTX_EVENT<Object3D::Viewpoint *>( VTX::App::Old::Event::Global::VIEWPOINT_ADDED, p_viewpoint );
	}
	void Path::removeViewpoint( Object3D::Viewpoint * const p_viewpoint )
	{
		...
		VTX_EVENT<Object3D::Viewpoint *>( VTX::App::Old::Event::Global::VIEWPOINT_REMOVED, p_viewpoint );
	}
	...
	*/
	...
	Object3D::Viewpoint Path::getInterpolatedViewpoint( const float p_time ) const
	{
		...
		if ( _modeInterpolation == App::Old::Component::Video::PATH_INTERPOLATION_MODE::LINEAR )
		{
			// Computes value.
			...
			if ( controller == VTX::App::Old::ID::Controller::TRACKBALL )
			{
		...
		else if ( _modeInterpolation == App::Old::Component::Video::PATH_INTERPOLATION_MODE::CATMULL_ROM )
		{
		...
		else if ( _modeInterpolation == App::Old::Component::Video::PATH_INTERPOLATION_MODE::CUBIC )
		{
			Object3D::Viewpoint * const p0	  = _viewpoints[ Util::Math::max<int>( 0, (int)offset - 2 ) ];
			Object3D::Viewpoint * const p1	  = _viewpoints[ offset - 1 ];
			Object3D::Viewpoint * const p2	  = _viewpoints[ Util::Math::min<int>( (int)size - 1, offset ) ];
	...
	void Path::refreshAllDurations()
	{
		...
		if ( _modeDuration == App::Old::Component::Video::PATH_DURATION_MODE::PATH )
		{
			float duration = 0.f;
		...
		else if ( _modeDuration == App::Old::Component::Video::PATH_DURATION_MODE::VIEWPOINT )
		{
			_duration = 0.f;
			for ( uint i = 1; i < _viewpoints.size(); ++i )
			{
		...
		else if ( _modeDuration == App::Old::Component::Video::PATH_DURATION_MODE::CONSTANT_SPEED )
		{
