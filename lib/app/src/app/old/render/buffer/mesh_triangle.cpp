...
namespace VTX::App::Old::Render::Buffer
{
	...
	void MeshTriangle::setColors( const std::vector<Util::Color::Rgba> & p_colors )
	{
	...
	void MeshTriangle::setIds( const std::vector<App::Old::Core::Model::ID> & p_ids ) { _updateBuffer( _vboIds, p_ids ); }
