...
namespace VTX::App::Old::Render::View
{
	...
	void Ribbon::render( const App::Old::Component::Render::Camera & p_camera ) const
	{
		BaseView3D::render( p_camera );

		if ( App::Old::VTXApp::get().MASK & Render::VTX_MASK_CAMERA_UPDATED )
		{
			const App::Old::Component::Render::Camera & cam = App::Old::VTXApp::get().getScene().getCamera();
