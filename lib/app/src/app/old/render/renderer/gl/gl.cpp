...
namespace VTX::App::Old::Render::Renderer::GL
{
	...
	void GL::renderFrame( const App::Old::Application::Scene & p_scene )
	{
		...
		App::Old::VTXApp::get().MASK = VTX_SETTING().getForceRenderer() ? Render::VTX_MASK_NEED_UPDATE : Render::VTX_MASK_NO_UPDATE;
	};
	...
	const Vec2i GL::getPickedIds( const uint p_x, const uint p_y ) const
	{
		...
		// Vec2i ids = Vec2i( App::Old::Core::Model::ID_UNKNOWN, App::Old::Core::Model::ID_UNKNOWN );
