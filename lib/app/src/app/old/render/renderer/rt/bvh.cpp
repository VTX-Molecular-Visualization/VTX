...
#include "app/old/render/renderer/rt/bvh.hpp"
#include <algorithm>
#include <thread>
...
namespace VTX::App::Old::Render::Renderer::RT
{
	...
	struct BVHBuildNode
	{
		...
		{
			_aabb = App::Old::Component::Object3D::Helper::AABB::join( p_child0->_aabb, p_child1->_aabb );
			++interiorNodes;
		}
	...
	{
		BVHPrimInfo() {}
		BVHPrimInfo( const uint p_idPrimitive, const App::Old::Component::Object3D::Helper::AABB & p_aabb ) :
											...
											std::vector<Primitive::BasePrimitive *> & p_outPrims )
	{
		...
		else
		{
			...
			App::Old::Component::Object3D::Helper::AABB centroidsAABB;
			for ( uint i = p_begin; i < p_end; ++i )
			{
			...
			else
			{
				...
				{
					App::Old::Component::Object3D::Helper::AABB aabb0;
					uint								   count0 = 0;
					for ( uint j = 0; j <= i; ++j )
					{
					...
					App::Old::Component::Object3D::Helper::AABB aabb1;
					uint								   count1 = 0;
