...
#include "enum/trajectory_enum.hpp"
#include "generic/base_representable.hpp"
#include "generic/base_scene_item.hpp"
#include "model/base_model_3d.hpp"
#include "model/chemistry/configuration/molecule.hpp"
	...
	namespace Model
	{
			...
			public Generic::BaseSceneItem
		{
		  ...
		  public:
			...
			// TODO VTX_LOGIC Manage molecule path out of VTX_LOGIC (extend Model::Molecule in VTX_APP ?)
