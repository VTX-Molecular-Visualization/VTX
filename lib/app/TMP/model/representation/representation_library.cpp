...
// #include "manager/worker/representation_loader.hpp"
#include "manager/worker/worker_manager.hpp"
...
namespace VTX::Model::Representation
{
	...
	{
		// TODO VTX_LOGIC Manage Save / Load out of VTX_LOGIC
	...
	void RepresentationLibrary::setDefaultRepresentation( const int p_representationIndex, const bool p_notify )
	{
		...
		{
			_defaultRepresentation = getRepresentationByName( Setting::REPRESENTATION_DEFAULT_NAME );
		...
		// TODO VTX_LOGIC Manage setting out of this project
