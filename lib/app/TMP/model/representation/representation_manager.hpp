...
// TODO VTX_LOGIC rethink this class to not build it as a singleton
// TODO VTX_LOGIC link a representationLibrary item instead of using a singleton on representationLibrary (which will
...
namespace VTX::Representation
{
	class RepresentationManager final
	{
	  ...
	  public:
		inline RepresentationLibrary * getRepresentationLibrary() const { return _representationLibrary; }
		// TODO VTX_LOGIC call this function at the right place
		inline void setRepresentationLibrary( RepresentationLibrary * const p_representationLibrary )
		{
			_representationLibrary = p_representationLibrary;
		}
	  ...
	  private:
		...
		RepresentationLibrary * _representationLibrary = nullptr;
