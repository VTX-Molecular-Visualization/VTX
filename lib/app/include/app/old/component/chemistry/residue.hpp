#ifndef __VTX_APP_OLD_COMPONENT_CHEMISTRY_RESIDUE__
#define __VTX_APP_OLD_COMPONENT_CHEMISTRY_RESIDUE__
...
namespace VTX::App::Old::Component::Chemistry
{
		...
		public App::Old::Application::Representation::BaseRepresentable
	{
	  ...
	  public:
		...
		App::Old::Component::Object3D::Helper::AABB getWorldAABB() const;

	  protected:
		Residue() : BaseModel( App::Old::ID::Model::MODEL_RESIDUE ) {}
