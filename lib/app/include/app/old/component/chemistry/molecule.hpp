#ifndef __VTX_APP_OLD_COMPONENT_CHEMISTRY_MOLECULE__
#define __VTX_APP_OLD_COMPONENT_CHEMISTRY_MOLECULE__
...
namespace VTX::App::Old::Component::Chemistry
{
	...
	class Molecule :
		public Core::Model::BaseModel3D<App::Old::Render::Buffer::Molecule>,
		...
		public Core::Scene::BaseSceneItem
	{
	  ...
	  public:
		...
		// BaseSceneItem
		const App::Old::Core::Model::ID & getModelID() const override { return getId(); }
		...
		void refreshSelection( const App::Old::Application::Selection::SelectionModel::MapChainIds * const );
		...
		void propagateEventToViews( const App::Old::Core::Event::VTXEvent * const p_event ) { _notifyViews( p_event ); }

		template<typename... Args>
		inline void propagateEventToViews( const App::Old::Core::Event::VTX_EVENT & p_eventID, Args... p_args )
		{
			_notifyViews( p_eventID, p_args... );
		}
		void propagateEventToViews( const App::Old::Core::Event::VTX_EVENT & p_eventID ) { _notifyViews( p_eventID ); }
	  ...
	  protected:
		...
		Molecule();
		Molecule( const VTX::App::Old::VTX_ID & p_typeId );
		virtual ~Molecule();
	  ...
	  private:
		...
		std::vector<App::Old::Core::Model::ID> _defaultRepresentationIDs = std::vector<App::Old::Core::Model::ID>();

		// Fill Buffers Functions
		void _fillBufferAtomColors();
		void _fillBufferAtomVisibilities();
		void _fillBufferAtomSelections( const App::Old::Application::Selection::SelectionModel::MapChainIds * const
										= nullptr );
	};
} // namespace VTX::App::Old::Component::Chemistry
