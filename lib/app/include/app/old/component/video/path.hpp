#ifndef __VTX_APP_OLD_COMPONENT_VIDEO_PATH__
#define __VTX_APP_OLD_COMPONENT_VIDEO_PATH__

#include "app/old/application/setting.hpp"
#include "app/old/component/object3d/viewpoint.hpp" // viewpoint included because Object3D::Viewpoint getInterpolatedViewpoint( const float p_time ) const. Maybe change the function to remove this include
