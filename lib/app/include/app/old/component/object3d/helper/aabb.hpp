#ifndef __VTX_APP_OLD_COMPONENT_OBJECT3D_HELPER_AABB__
#define __VTX_APP_OLD_COMPONENT_OBJECT3D_HELPER_AABB__
...
namespace VTX::App::Old::Component::Object3D::Helper
{
	class AABB : public BaseHelper
	{
	  ...
	  private:
		...
		App::Old::Render::Renderer::GL::Buffer _ibo	   = App::Old::Render::Renderer::GL::Buffer();
		uint							  _iboSize = 0;
