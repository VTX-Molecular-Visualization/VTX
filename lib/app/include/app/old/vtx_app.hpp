#ifndef __VTX_APP_OLD_VTX_APP__
#define __VTX_APP_OLD_VTX_APP__
...
#include "app/old/internal/monitoring/stat.hpp"
#include "app/old/render/define.hpp"
...
namespace VTX
{
	...
	inline App::Old::Application::Setting &		  VTX_SETTING() { return App::Old::VTXApp::get().getSetting(); }
	inline App::Old::Internal::Monitoring::Stat & VTX_STAT() { return App::Old::VTXApp::get().getStat(); }
	inline App::Old::Render::Spec &				  VTX_SPEC() { return App::Old::VTXApp::get().getSpec(); }
