#ifndef __VTX_APP_OLD_INTERNAL_ALGORITHM_BOND_RECOMPUTATION__
#define __VTX_APP_OLD_INTERNAL_ALGORITHM_BOND_RECOMPUTATION__
...
namespace VTX::App::Old::Internal::Algorithm
{
	class BondRecomputation
	{
	  private:
		...
		{
		  public:
			CellList( const App::Old::Component::Object3D::Helper::AABB & p_aabb, const float p_cubeSize ) :
	  ...
	  public:
		static void recomputeBonds( chemfiles::Frame & p_frame, const App::Old::Component::Object3D::Helper::AABB & p_aabb );
