#ifndef __VTX_APP_OLD_INTERNAL_ALGORITHM_MARCHING_CUBE__
#define __VTX_APP_OLD_INTERNAL_ALGORITHM_MARCHING_CUBE__
...
namespace VTX::App::Old::Internal::Algorithm
{
	class MarchingCube
	{
	  public:
		...
		std::vector<std::vector<Vec4f>> triangulateCell( const GridCell & p_gridCell, const float p_isovalue ) const;
