#ifndef __VTX_APP_OLD_INTERNAL_WORKER_LOADER__
#define __VTX_APP_OLD_INTERNAL_WORKER_LOADER__
...
{
	class Loader : public App::Old::Core::Worker::BaseThread
	{
		// Q_OBJECT
	  ...
	  public:
		...
		struct Result
		{
		  ...
		  public:
			...
			App::Old::Component::Object3D::MeshTriangle * mesh	  = nullptr;
		...
		inline void addDynamicTarget( App::Old::Component::Chemistry::Molecule * const p_target )
		{
	  ...
	  protected:
		...
		void _loadConfigurationFiles( App::Old::Component::IO::MoleculeConfiguration & );
		void _loadMoleculeFiles( const App::Old::Component::IO::MoleculeConfiguration & );
		void _loadTrajectoriesFiles( const App::Old::Component::IO::MoleculeConfiguration & p_config );
		void _loadMeshFiles();
	  ...
	  private:
		...
		std::vector<App::Old::Component::Chemistry::Molecule *> _moleculeTargetsForDynamics
