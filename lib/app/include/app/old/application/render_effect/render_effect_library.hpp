#ifndef __VTX_APP_OLD_APPLICATION_RENDER_EFFECT_RENDER_EFFECT_PRESET_LIBRARY__
#define __VTX_APP_OLD_APPLICATION_RENDER_EFFECT_RENDER_EFFECT_PRESET_LIBRARY__
...
{
	class RenderEffectLibrary : public App::Old::Core::Model::BaseModel
	{
		VTX_MODEL
	  ...
	  private:
		...
		void _onPresetChange( const App::Old::Core::Event::VTXEvent * const p_event );
