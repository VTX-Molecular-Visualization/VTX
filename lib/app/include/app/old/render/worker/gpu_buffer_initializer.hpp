#ifndef __VTX_APP_OLD_RENDER_WORKER_GPU_BUFFER_INITIALIZER__
#define __VTX_APP_OLD_RENDER_WORKER_GPU_BUFFER_INITIALIZER__
...
namespace VTX::App::Old::Render::Worker
{
	...
	{
	  public:
		explicit GpuBufferInitializer( App::Old::Render::Renderer::GL::Buffer & p_buffer,
									   const size_t						   p_size,
		...
		void start() override
		{
			_buffer.bind( App::Old::Render::Renderer::GL::Buffer::Target::SHADER_STORAGE_BUFFER, 0 );
			GpuComputer::start();
			_buffer.unbind();
		}
	  ...
	  private:
		...
		App::Old::Render::Renderer::GL::Buffer & _buffer;
