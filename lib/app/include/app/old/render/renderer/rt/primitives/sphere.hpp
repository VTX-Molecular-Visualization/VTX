#ifndef __VTX_APP_OLD_RENDER_RENDERER_RT_SPHERE__
#define __VTX_APP_OLD_RENDER_RENDERER_RT_SPHERE__
...
namespace VTX::App::Old::Render::Renderer::RT::Primitive
{
	class Sphere : public BasePrimitive
	{
	  public:
		~Sphere() = default;
		Sphere( const Vec3f & p_center, const float p_radius, Material::BaseMaterial * const p_mtl ) :
	  ...
	  private:
		void _computeAABB() override { _aabb = App::Old::Component::Object3D::Helper::AABB( getVecMin(), getVecMax() ); }
