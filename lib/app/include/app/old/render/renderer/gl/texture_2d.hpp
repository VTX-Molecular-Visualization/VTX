#ifndef __VTX_APP_OLD_RENDER_GL_TEXTURE_2D__
#define __VTX_APP_OLD_RENDER_GL_TEXTURE_2D__
...
namespace VTX::App::Old::Render::Renderer::GL
{
	...
	class Texture2D : public Render::Generic::BaseOpenGL
	{
	  public:
		...
		inline void bindToUnit( const GLuint p_unit ) const
		{
			//_gl->glBindTextureUnit( p_unit, _id );
		}
...
#endif // __VTX_APP_OLD_RENDER_GL_TEXTURE_2D__
