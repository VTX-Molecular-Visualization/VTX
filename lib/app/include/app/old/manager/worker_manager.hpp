#ifndef __VTX_APP_OLD_MANAGER_WORKER_MANAGER__
#define __VTX_APP_OLD_MANAGER_WORKER_MANAGER__
...
{
	using namespace VTX::App::Old::Core::Worker;
	...
	class WorkerManager final // : public QObject
	{
	  ...
	  private:
		...
		//{
		//	VTX_EVENT<float>( VTX::App::Old::Event::Global::UPDATE_PROGRESS_BAR, p_progress );
		// }
