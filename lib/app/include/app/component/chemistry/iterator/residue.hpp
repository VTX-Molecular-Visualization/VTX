...
namespace VTX::App::Component::Chemistry::Iterator
{
	struct ResidueContainer
	{
		struct ResidueIt
		{
			ResidueIt( System * const p_molecule, const size_t p_index, const size_t p_end );
		...
		ResidueContainer( System * const p_molecule, const size_t p_firstResidueIndex, const size_t p_residueCount );
