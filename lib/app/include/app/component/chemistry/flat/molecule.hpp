#ifndef __VTX_APP_COMPONENT_CHEMISTRY_FLAT_MOLECULE__
#define __VTX_APP_COMPONENT_CHEMISTRY_FLAT_MOLECULE__
...
namespace VTX::App::Component::Chemistry::Flat
{
	class Molecule
	{
	  ...
	  public:
		Molecule();
		Molecule( VTX::Core::FlatStruct::Molecule & p_moleculeStruct );
		~Molecule();

		void setMoleculeStruct( VTX::Core::FlatStruct::Molecule & p_moleculeStruct );
	  ...
	  private:
		VTX::Core::FlatStruct::Molecule _moleculeStruct = VTX::Core::FlatStruct::Molecule();
