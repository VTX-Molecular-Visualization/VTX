...
namespace VTX::App::Component::Chemistry
{
		...
		public Generic::BaseRepresentable
	{
	  ...
	  public:
		...
		inline bool isStandardResidue() const { return int( SYMBOL::ALA ) <= _symbol && _symbol <= int( SYMBOL::PYL ); }
		inline bool isWater() const { return ( _symbol == int( SYMBOL::WAT ) ) || ( _symbol == int( SYMBOL::HOH ) ); }
