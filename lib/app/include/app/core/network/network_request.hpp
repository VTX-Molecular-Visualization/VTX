#ifndef __VTX_APP_CORE_NETWORK_NETWORK_REQUEST__
#define __VTX_APP_CORE_NETWORK_NETWORK_REQUEST__

// #include <QNetworkReply>
// #include <QNetworkRequest>
#include <string>

#define VTX_REQUEST friend VTX::App::Manager::NetworkManager;
