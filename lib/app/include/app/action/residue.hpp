...
namespace VTX::App::Action::Residue
{
	...
	{
	  public:
		explicit ChangeColor( App::Component::Chemistry::Residue & p_residue, const Util::Color::Rgba & p_color ) :
			_color( p_color ), _residues { &p_residue }
		{
			_tag = Core::Action::ACTION_TAG( _tag | Core::Action::ACTION_TAG::MODIFY_SCENE );
		}
		explicit ChangeColor( const std::unordered_set<App::Component::Chemistry::Residue *> & p_residues, const Util::Color::Rgba & p_color ) :
