#ifndef __VTX_APP_ECS_CORE_BASE_ENTITY__
#define __VTX_APP_ECS_CORE_BASE_ENTITY__
...
namespace VTX::App::ECS
{
	...
	inline static const Core::BaseEntity INVALID_ENTITY = Core::BaseEntity( UINT_MAX );
} // namespace VTX::App::ECS
