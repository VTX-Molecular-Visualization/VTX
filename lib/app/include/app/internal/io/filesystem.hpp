#ifndef __VTX_APP_INTERNAL_IO_FILESYSTEM__
#define __VTX_APP_INTERNAL_IO_FILESYSTEM__
...
namespace VTX::App::Internal::IO::Filesystem
{
	...
	inline FilePath getDefaultMoleculeExportPath()
	{
		...
		{
			const App::Core::Model::ID & moleculeID = App::Application::Selection::SelectionManager::get()
														  .getSelectionModel()
														  .getMoleculesMap()
														  .begin()
														  ->first;
	...
	inline std::string getImageExportDefaultFilter()
	{
		...
		{
		case App::Internal::IO::Serialization::ImageExport::Format::PNG: filter = "PNG (*.png)"; break;
		case App::Internal::IO::Serialization::ImageExport::Format::JPEG: filter = "JPEG (*.jpg *.jpeg)"; break;
		case App::Internal::IO::Serialization::ImageExport::Format::BMP: filter = "BMP (*.bmp)"; break;
