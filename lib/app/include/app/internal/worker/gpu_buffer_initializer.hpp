...
namespace VTX::Worker
{
	...
	{
	  public:
		explicit GpuBufferInitializer( App::Render::Renderer::GL::Buffer & p_buffer,
									   const size_t						   p_size,
		...
		void start() override
		{
			_buffer.bind( App::Render::Renderer::GL::Buffer::Target::SHADER_STORAGE_BUFFER, 0 );
			GpuComputer::start();
			_buffer.unbind();
		}
	  ...
	  private:
		...
		App::Render::Renderer::GL::Buffer & _buffer;
