...
{
	class RayTracer : public App::Render::Renderer::BaseRenderer
	{
	  ...
	  public:
		...
		void updateRenderSetting( const App::Render::Renderer::RENDER_SETTING ) override {}
	  ...
	  private:
		...
		App::Render::Renderer::GL::Texture2D _texture = App::Render::Renderer::GL::Texture2D();
