#ifndef __VTX_APP_RENDER_RENDERER_RT_SPHERE__
#define __VTX_APP_RENDER_RENDERER_RT_SPHERE__
...
namespace VTX::App::Render::Renderer::RT::Primitive
{
	class Sphere : public BasePrimitive
	{
	  ...
	  private:
		void _computeAABB() override { _aabb = App::Component::Object3D::Helper::AABB( getVecMin(), getVecMax() ); }
