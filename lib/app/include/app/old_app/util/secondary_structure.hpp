...
namespace VTX::Util::SecondaryStructure
{
	...
	static ChemDB::SecondaryStructure::TYPE pdbFormattedToEnumSecondaryStructure( const std::string & p_str )
	{
	...
	static std::string enumToPdbFormattedSecondaryStructure( const ChemDB::SecondaryStructure::TYPE p_enum )
	{
		std::string res;
