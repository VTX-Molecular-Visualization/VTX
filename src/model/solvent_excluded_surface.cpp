...
namespace VTX
{
	namespace Model
	{
		...
		void SolventExcludedSurface::_initGPU()
		{
			...
			// Worker.
			Worker::GpuComputer workerCreateSDF = Worker::GpuComputer( IO::FilePath( "ses/create_sdf.comp" ) );
			// Input data.
			BufferStorage ssboAtomData = BufferStorage( BufferStorage::Target::SHADER_STORAGE_BUFFER, sesGridData );
			// Output data.
			BufferStorage ssboGridData = BufferStorage( BufferStorage::Target::SHADER_STORAGE_BUFFER, sesGridData );
