...
namespace VTX
{
	namespace ID
	{
		...
		namespace Model
		{
			...
			const VTX_ID MODEL_CONTOUR_BUILDUP	   = "MODEL_CONTOUR_BUILDUP";
			...
			const VTX_ID MODEL_BOX				   = "MODEL_BOX";
		...
		namespace View
		{
			...
			const VTX_ID D3_TORUS_PATCH				 = "D3_TORUS_PATCH";
			const VTX_ID D3_SPHERICAL_TRIANGLE_PATCH = "D3_SPHERICAL_TRIANGLE_PATCH";
