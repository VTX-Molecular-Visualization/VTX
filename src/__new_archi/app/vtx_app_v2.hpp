...
namespace VTX
{
	...
	namespace App
	{
		...
		{
		  public:
			inline static VTXAppV2 & get()
			{
				static VTXAppV2 instance;
				return instance;
			}
			...
			//	return *_representationLibrary;
			// }
			// inline Model::Renderer::RenderEffectPresetLibrary & getRenderEffectLibrary()
			//{
		  ...
		  private:
			...
			VTXAppV2();
			VTXAppV2( const VTXAppV2 & )			 = delete;
			VTXAppV2 & operator=( const VTXAppV2 & ) = delete;
			~VTXAppV2();
