...
#include "__new_archi/ui/qt/widget/render/contextual_menu_render.hpp"
...
namespace VTX::UI::DefaultTools
{
	...
	void RenderWindow::setupContextualMenu() const
	{
		...
		QT::Widget::Render::ContextualMenuRender * defaultContextualMenu
			= QT::WidgetFactory::get().instantiateWidget<QT::Widget::Render::ContextualMenuRender>(
				mainWindow, "contextualMenuRender" );

		mainWindow->getContextualMenu().registerMenu( DefaultTools::ContextualMenu::RENDER, defaultContextualMenu );
	}
