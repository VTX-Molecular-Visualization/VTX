#ifndef __VTX_UI_QT_CONTROLLER_BASE_GAMEPAD_CONTROLLER__
#define __VTX_UI_QT_CONTROLLER_BASE_GAMEPAD_CONTROLLER__

#include "__new_archi/ui/core/controller/base_controller.hpp"
...
{
	class BaseGamepadController : public QObject, virtual public UI::Core::Controller::BaseController
	{
		Q_OBJECT
