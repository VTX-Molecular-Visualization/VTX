...
#include "__new_archi/ui/qt/action/application.hpp"
#include "__new_archi/ui/qt/widget/render/base_integrated_widget.hpp"
#include "__new_archi/ui/qt/widget/render/overlay/visualization_quick_access.hpp"
...
namespace VTX::UI::QT::Widget::Render
{
	...
	{
		QT::Widget::Render::Overlay::BaseOverlay * res;

		switch ( p_overlayType )
		{
		case Overlay::OVERLAY::VISUALIZATION_QUICK_ACCESS:
			res = QT::WidgetFactory::get().instantiateWidget<QT::Widget::Render::Overlay::VisualizationQuickAccess>(
				this, "" );
			break;
