#ifndef __VTX_UI_QT_WIDGET_SCENE_VIEW_MOLECULE_SCENE_VIEW__
#define __VTX_UI_QT_WIDGET_SCENE_VIEW_MOLECULE_SCENE_VIEW__
...
namespace VTX::UI::QT::Widget::Scene::View
{
	class MoleculeSceneView :
		public VTX::View::BaseView<Model::Molecule>,
		public VTX::UI::QT::Widget::Scene::SceneItemWidget
	{
