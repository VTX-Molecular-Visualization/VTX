#ifndef __VTX_UI_QT_WIDGET_SCENE_VIEW_PATH_SCENE_VIEW__
#define __VTX_UI_QT_WIDGET_SCENE_VIEW_PATH_SCENE_VIEW__
...
{
	class PathSceneView : public VTX::View::BaseView<Model::Path>, public VTX::UI::QT::Widget::Scene::SceneItemWidget
	{
