...
public:
    ...
    void setupUi(QWidget *ManageCloudsWindowDialog)
    {
        ...
        QObject::connect(listWidgetClouds, SIGNAL(currentRowChanged(int)), stackedWidgetCloudInformation, SLOT(setCurrentIndex(int)));
    ...
    {
        ManageCloudsWindowDialog->setWindowTitle(QCoreApplication::translate("ManageCloudsWindowDialog", "Form", nullptr));
#if QT_CONFIG(tooltip)
        pushButtonConnectCloud->setToolTip(QCoreApplication::translate("ManageCloudsWindowDialog", "<html><head/><body><p>Connect to a cloud service</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButtonConnectCloud->setText(QString());
#if QT_CONFIG(tooltip)
        pushButtonRemove->setToolTip(QCoreApplication::translate("ManageCloudsWindowDialog", "<html><head/><body><p>Remove a connexion to a cloud service</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
