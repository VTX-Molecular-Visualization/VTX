		...
		namespace Widget
		{
			namespace Inspector
			{
				...
				void InspectorRepresentationWidget::_setupUi( const QString & p_name )
				{
					...
					_targetsField  = WidgetFactory::get().instantiateWidget<CustomWidget::RepresentableFieldWidget>( this, "inspector_item" );
					_targetSection->appendField( "Target", _targetsField );

					_colorModeField = WidgetFactory::get().instantiateWidget<CustomWidget::ColorModeFieldWidget>( this, "inspector_item" );
