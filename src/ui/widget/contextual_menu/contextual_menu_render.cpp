...
namespace VTX::UI::Widget::ContextualMenu
{
	...
	void ContextualMenuRender::_setupSlots()
	{
		...
		selectionGranularityMenu->addAction( "Atom" )
			->setProperty( SELECTION_GRANULARITY_PROPERTY_NAME, int( VTX::Selection::Granularity::ATOM ) );
		...
		selectionGranularityMenu->addAction( "Chain" )
			->setProperty( SELECTION_GRANULARITY_PROPERTY_NAME, int( VTX::Selection::Granularity::CHAIN ) );
