...
namespace VTX
{
	namespace UI
	{
		namespace Widget
		{
			...
			class BaseManualWidget : public W, public Event::BaseEventReceiverVTX, public WidgetInitializer
			{
			  public:
				BaseManualWidget( QWidget * p_parent = nullptr ) : W( p_parent ), WidgetInitializer() {};
