			...
			namespace MainMenu
			{
				namespace Visualization
				{
					...
					void MenuVisualizationRepresentationWidget::_setupUi( const QString & p_name )
					{
						...
						_preset1 = WidgetFactory::get().instanciateWidget<RepresentationPresetButton>( this, "applyVisualModelPresetButton" );
						...
						_preset2 = WidgetFactory::get().instanciateWidget<RepresentationPresetButton>( this, "applyVisualModelPresetButton" );
						...
						_preset3 = WidgetFactory::get().instanciateWidget<RepresentationPresetButton>( this, "applyVisualModelPresetButton" );
						...
						_preset4 = WidgetFactory::get().instanciateWidget<RepresentationPresetButton>( this, "applyVisualModelPresetButton" );
						_preset4->setData( "Custom preset 1", "", Qt::Orientation::Horizontal );
						_preset4->setRepresentationID( 3 );
						pushButton( *_preset4, 1 );

						_preset5 = WidgetFactory::get().instanciateWidget<RepresentationPresetButton>( this, "applyVisualModelPresetButton" );
						_preset5->setData( "Custom preset 2", "", Qt::Orientation::Horizontal );
						_preset5->setRepresentationID( 4 );
						pushButton( *_preset5, 1 );

						_preset6 = WidgetFactory::get().instanciateWidget<RepresentationPresetButton>( this, "applyVisualModelPresetButton" );
						_preset6->setData( "Custom preset 3", "", Qt::Orientation::Horizontal );
						_preset6->setRepresentationID( 5 );
						pushButton( *_preset6, 1 );

						_addPreset = WidgetFactory::get().instanciateWidget<RepresentationPresetButton>( this, "addNewVisualModelPresetButton" );
