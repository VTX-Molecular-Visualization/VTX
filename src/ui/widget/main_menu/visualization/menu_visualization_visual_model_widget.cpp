			...
			namespace MainMenu
			{
				namespace Visualization
				{
					...
					void MenuVisualizationVisualModelWidget::_setupUi( const QString & p_name )
					{
						...
						_preset1 = WidgetFactory::get().instanciateWidget<MenuToolButtonWidget>( this, "applyVisualModelPresetButton" );
						_preset1->setData( "Sticks", ":/sprite/representation_stick_icon.png", Qt::Orientation::Horizontal );
						pushButton( *_preset1, 0 );

						_preset2 = WidgetFactory::get().instanciateWidget<MenuToolButtonWidget>( this, "applyVisualModelPresetButton" );
						_preset2->setData( "Trace", ":/sprite/representation_trace_icon.png", Qt::Orientation::Horizontal );
						pushButton( *_preset2, 0 );

						_preset3 = WidgetFactory::get().instanciateWidget<MenuToolButtonWidget>( this, "applyVisualModelPresetButton" );
						_preset3->setData( "SAS", ":/sprite/representation_sas_icon.png", Qt::Orientation::Horizontal );
						pushButton( *_preset3, 0 );

						_preset4 = WidgetFactory::get().instanciateWidget<MenuToolButtonWidget>( this, "applyVisualModelPresetButton" );
						_preset4->setData( "Custom preset 1", "", Qt::Orientation::Horizontal );
						pushButton( *_preset4, 1 );

						_preset5 = WidgetFactory::get().instanciateWidget<MenuToolButtonWidget>( this, "applyVisualModelPresetButton" );
						_preset5->setData( "Custom preset 2", "", Qt::Orientation::Horizontal );
						pushButton( *_preset5, 1 );

						_preset6 = WidgetFactory::get().instanciateWidget<MenuToolButtonWidget>( this, "applyVisualModelPresetButton" );
						_preset6->setData( "Custom preset 3", "", Qt::Orientation::Horizontal );
						pushButton( *_preset6, 1 );

						_addPreset = WidgetFactory::get().instanciateWidget<MenuToolButtonWidget>( this, "addNewVisualModelPresetButton" );
