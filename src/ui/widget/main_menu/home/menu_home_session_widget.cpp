			...
			namespace MainMenu
			{
				namespace Home
				{
					...
					void MenuHomeSessionWidget::_setupUi( const QString & p_name )
					{
						...
						_loadSettingsButton = WidgetFactory::get().getWidget<MenuToolButtonWidget>( this, "loadSettingsButton" );
						...
						_saveSettingsButton = WidgetFactory::get().getWidget<MenuToolButtonWidget>( this, "saveSettingsButton" );
