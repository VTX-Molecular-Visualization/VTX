			...
			namespace MainMenu
			{
				namespace Home
				{
					...
					void MenuHomeMoleculeWidget::_setupUi( const QString & p_name )
					{
						...
						_loadMoleculeButton = WidgetFactory::get().instanciateWidget<MenuToolButtonWidget>( this, "loadMoleculeButton" );
						_loadMoleculeButton->setData( "Load", ":/sprite/load_molecule_icon.png", Qt::Orientation::Vertical );
						pushButton( *_loadMoleculeButton, 0 );

						_downloadMoleculeButton = WidgetFactory::get().instanciateWidget<MenuToolButtonWidget>( this, "downloadMoleculeButton" );
						...
						_saveMoleculeButton = WidgetFactory::get().instanciateWidget<MenuToolButtonWidget>( this, "saveMoleculeButton" );
						_saveMoleculeButton->setData( "Save", ":/sprite/save_molecule_icon.png", Qt::Orientation::Vertical );
						pushButton( *_saveMoleculeButton, 2 );

						validate();

						_downloadMoleculeDialog = WidgetFactory::get().instanciateWidget<Dialog::DownloadMoleculeDialog>( this, "downloadMoleculeDialog" );
					}
