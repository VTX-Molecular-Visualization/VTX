#ifndef __VTX_ACTION_TRANSFORMABLE_SCALE__
#define __VTX_ACTION_TRANSFORMABLE_SCALE__
...
namespace VTX
{
	namespace Action
	{
		...
		class TransformableScale : public BaseActionUndonable
		{
		  public:
			explicit TransformableScale( T & p_transformable, const float p_scale ) :
