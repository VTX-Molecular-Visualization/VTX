...
if (NOT DEFINED VTX_TOOL_TOPOLOGY_EDITOR)
	set(VTX_TOOL_TOPOLOGY_EDITOR 1)
endif()
if (NOT DEFINED VTX_UI_QT)
	set(VTX_UI_QT 1)
endif()
...
if (NOT DEFINED _VTX_CONAN)
	...
	if (VTX_TOOL_TOPOLOGY_EDITOR)
		target_link_libraries(vtx PRIVATE vtx_tool_topology_editor)
	endif()
else()
