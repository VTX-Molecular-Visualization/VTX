...
namespace vidocklab
{
	VdwSphereSSBORep::VdwSphereSSBORep(const AMolecule *mol) : AMoleculeRep(mol)
	{
	...
	void VdwSphereSSBORep::initBuffers()
	{
		...
		//{
		//	data.emplace_back(m_refMolecule.m_atomPositions[i],
		//					  m_refMolecule.m_atomColors[i],
		//					  m_refMolecule.m_atomRadii[i]);
		//}
		...
		// sizeof(GLuint), 			 m_indices.data(), GL_STATIC_DRAW);
